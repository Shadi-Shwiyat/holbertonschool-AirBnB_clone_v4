$(document).ready(function () {
    ...
    $ajax({
        url: 'http://0a5f2fab0457.a72dbe54.hbtn-cod.io:5001/api/v1/places_search/',
        type: 'POST',
        dataType: 'json',
        ...
        success: function (data) {
            for (const place of data) {
                ...
                $.get('http://0a5f2fab0457.a72dbe54.hbtn-cod.io:5001/api/v1/users' + place.user_id, function (userData) {
                    const palceHTML = `<article>
                    <div class="title_box">
                      <h2>${place.name}</h2>
